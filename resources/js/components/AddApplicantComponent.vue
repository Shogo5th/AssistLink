                                    ...
                                    <form class="p-3" v-on:submit.prevent="checkValidation">
                                        <div class="form-row my-5">
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                name="firstname" v-on:click="detectInput">
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="text" required pattern=.*\S+.* oninvalid="this.setCustomValidity('Enter Lastname without space.')" 
                                        ...
                                        <div class="form-row my-5">
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                placeholder="Address" name="address" v-on:click="detectInput">
